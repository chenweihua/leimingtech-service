...
import com.leimingtech.core.common.PinYinUtil;
...
public class StoreWordsServiceImpl implements StoreWordsService{
	 ...
	 */
	@Override
	public void saveKeywordToDatabase(Analyzer analyzer, String storeName){
		try {
...
//		    int endOffset = offsetAttribute.endOffset();
	...
	private void saveToDatabase(String keyword){
		...
		if(wordsId == null){/*不存在,需要插入*/
			...
			storeWords.setUpdateTime(System.currentTimeMillis());
			/**保存*/
