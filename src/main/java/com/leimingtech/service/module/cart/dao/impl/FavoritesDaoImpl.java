...
import com.leimingtech.service.module.cart.dao.mapper.FavoritesMapper;
...
public class FavoritesDaoImpl extends BaseDao implements FavoritesDao {
	 ...
	 * @return
	 */
	public int findCountFav(Favorites favorites){
		return favoritesMapper.findCountFav(favorites);
	}
}
