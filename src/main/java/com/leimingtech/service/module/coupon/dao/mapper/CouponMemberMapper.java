...
public interface CouponMemberMapper {
	 ...
	 * @return
	 */
	public List<CouponMember> findCouponsByConditions(@Param("memberId")Integer memberId,@Param("storeIds")String storeIds,@Param("goodsClassIds")String goodsClassIds);
	/**
	 * 通过条件查询会员优惠券
