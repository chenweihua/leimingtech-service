package com.leimingtech.service.module.push;

import java.util.HashMap;
import java.util.Map;

import com.leimingtech.core.push.MessagePush;
import com.leimingtech.core.push.util.PushType;
...
public class ServiceMessagePush {
	...
	public static void main(String[] args) {
		...
		orderShipPushForH5("订单已发货", "你购买的商品已发货", "订单发货:您的订单已发货", 10, "http://b2b2c.leimingtech.com/leimingtech-front/m/authc/buyer/orderList?orderState=99");
	}
}
